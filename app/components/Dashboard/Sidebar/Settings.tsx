  ...
  return (
    <main className="bg-white h-screen p-8 flex flex-col gap-8">
      <section className="flex gap-6 items-center">
        <Image src={img} alt="User Add image" width={93} height={93} />
      ...
      <form className="grid grid-cols-2 gap-6">
        <div>
          ...
          <input
            {...register("name")}
            className="bg-[#f9f9f9] px-4 py-3 placeholder:text-[#a2a2a2]
                text-black w-full rounded-xl"
            type="text"
            placeholder="Your name"
          />
          <span className="font-bold text-sm text-red-500 h-0">
            {errors.name?.message}
          </span>
        </div>
        <div>

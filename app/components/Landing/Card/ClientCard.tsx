import { ClientCardType } from "@/lib/types/ClientCard";
import Image from "next/image";

const ClientCard = ({ img, name, job, text }: ClientCardType) => {
  return (
    <article className="bg-white flex flex-col gap-10
    px-11.5 py-10.75 max-w-111.75 rounded-2xl shadow-sm">
